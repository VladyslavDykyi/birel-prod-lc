...
const share_type1 = document.querySelector('#share_type_bid');
const share_type_currency1 = document.querySelector('#share_type_currency_bid1');
const share_type_currency2 = document.querySelector('#share_type_currency_bid2');
const share_price = document.querySelector('#share_price_bid');
const share_number = document.querySelector('#share_number_bid');
const volume1 = document.querySelector('#volume_bid');
const share_type2 = document.querySelector('#share_type_bid2');
const volume2 = document.querySelector('#volume_bid2');
const valuation = document.querySelector('#share_number_bid2');
const btn = document.querySelector('#btn_calc_bid');
